...
@section('content')
    ...
    <div class="dashboard-page res-settings-page" data-settings-tabs data-settings-active-tab="{{ $initialTab }}">
        ...
        <section class="settings-tab-panel" id="settings-panel-security" role="tabpanel" aria-labelledby="settings-tab-security" data-settings-panel="security" @if ($initialTab !== 'security') hidden @endif><section class="settings-section"><div class="settings-section-heading settings-security-heading"><span><x-dashboard.icon name="lock" size="23" /></span><div><h2>Security and Privacy</h2><p>Manage your account security and personal information.</p></div></div>@include('settings.partials.security-forms')</section></section>
