    ...
    <div class="dashboard-page report-page">
        ...
        <form class="report-filter-panel" method="GET" action="{{ route('res.reports.index') }}">
            <div class="report-filter-grid">
                ...
                <label><span>Institution</span><select name="institution"><option value="">All institutions</option>@foreach ($institutions as $institution)<option value="{{ $institution }}" @selected(($filters['institution'] ?? '') === $institution)>{{ $institution }}</option>@endforeach</select></label>
