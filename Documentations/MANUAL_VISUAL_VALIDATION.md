...
| Applicant Form | Research Information, Institute Information, and Study Scope render as separate icon-headed sections; required markers, Student/Faculty differences, Cancel, and Save and Continue match the supplied reference without overlap. | Pending | Implemented in code but pending manual visual verification. | Not captured |
