...
| D-ALL-C | Profile Summary displays actual institutional/contact/position data | Verified complete | Role summary responses render stored phone, institution, department/program, and Adviser designation. |
...
| E-SEED | Consistent institution/department/program and safe mock profile data | Verified complete | All three development/demo seeders use the specified institution, Computer Studies, BSCS, and populated mock contact/designation fields. |
...
| E-REPORT-01 | Reports filters and eight summary cards | Verified complete | Authorized Form Request/controller/service implement term-first plus date/type/category/classification/department/institution/status filters and all requested cards from stored data. |
