...
<svg <?php echo e($attributes->class('dashboard-icon')); ?> width="<?php echo e($size); ?>" height="<?php echo e($size); ?>" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
    <?php switch($name):
        case ('home'): ?>
        ...
        <?php case ('file'): ?>
            ...
            <?php break; ?>
        <?php case ('file-pdf'): ?>
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><path d="M14 2v6h6M7 15h2a2 2 0 0 0 0-4H7v6M13 11v6h1a3 3 0 0 0 0-6ZM18 17v-6h3"/>
            <?php break; ?>
        <?php case ('file-word'): ?>
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><path d="M14 2v6h6M7 12l1.5 5 1.5-4 1.5 4 1.5-5"/>
            <?php break; ?>
        <?php case ('file-spreadsheet'): ?>
            <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z"/><path d="M14 2v6h6M8 13h8M8 17h8M12 11v8"/>
            <?php break; ?>
        <?php case ('image'): ?>
...
<?php /**PATH C:\Users\Ace Arthur\OneDrive\Documents\GitHub\Ethics-Certification-Research-Application-Tracking-System\resources\views/components/dashboard/icon.blade.php ENDPATH**/ ?>